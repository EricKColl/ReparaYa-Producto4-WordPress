...
<div class="form-shell">
    ...
    <section class="form-hero">
        ...
        <h1 class="form-hero-title">Editar especialidad</h1>
    </section>
        ...
        <form action="{{ route('especialidades.update', $especialidad->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    required
                >
                <span class="field-hint">Modificar este nombre afecta a la forma en que se identifica el servicio dentro del sistema.</span>
            </div>
