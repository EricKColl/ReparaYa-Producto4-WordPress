...
<div class="form-shell">
    ...
    <section class="form-hero">
        ...
        <h1 class="form-hero-title">Editar usuario</h1>
    </section>

    @if ($errors->any())
        <div class="error-panel">
            <strong>No se ha podido actualizar el usuario.</strong>
            <ul>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        required
                    >
                    <span class="field-hint">Correo de acceso del usuario.</span>
                </div>
                ...
                <div class="form-group">
                    ...
                    >
                    <span class="field-hint">Solo se cambiará si escribes una nueva contraseña.</span>
                </div>

                <div class="form-group">
                    <label>Rol</label>
                    <select name="rol" class="form-control" required>
                        <option value="particular" {{ old('rol', $usuario->rol) == 'particular' ? 'selected' : '' }}>
                            Particular
                        </option>
                    ...
                    <span class="field-hint">Define los permisos funcionales dentro de la plataforma.</span>
                </div>
                ...
                <div class="form-group form-group-full">
                    ...
                    >
                    <span class="field-hint">Dato de contacto asociado al perfil.</span>
                </div>
            </div>
