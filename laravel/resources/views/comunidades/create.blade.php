...
<div class="community-form-shell">
    ...
    <section class="community-hero">
        <div class="community-hero-content">
            <div>
                ...
                <p>
                    Registra una comunidad de propietarios y vincúlala a una gestora. Esta información permitirá crear avisos B2B con dirección, zona y teléfono de contacto ya preparados.
                </p>
            </div>
    ...
    @if($errors->any())
        <div class="community-error">
            <strong>No se ha podido crear la comunidad.</strong>
            <ul>
    ...
    <section class="community-form-card">
        <div class="community-form-content">
            ...
            <div class="community-form-head">
                ...
                <p>
                    Define la gestora responsable, la dirección real del edificio, el teléfono operativo y la zona que se utilizará en el análisis REST de servicios por área.
                </p>
            </div>
            ...
            <form action="{{ route('comunidades.store') }}" method="POST">
                ...
                <div class="community-grid">
                    ...
                    <div class="community-field full">
                        ...
                        <small>
                            La comunidad quedará disponible únicamente para la gestora seleccionada cuando acceda al panel B2B.
                        </small>
                    </div>
                    ...
                    <div class="community-field">
                        ...
                        <input
                            ...
                            placeholder="Ejemplo: Comunidad Calle Goya 10"
                            value="{{ old('nombre') }}"
                            required
                        >
                    </div>
                    ...
                    <div class="community-field">
                        ...
                        <input
                            ...
                            id="zona"
                            class="community-input"
                            placeholder="Ejemplo: Centro, Norte, Sur..."
                            value="{{ old('zona') }}"
                            required
                        >

                        <small>
                            Este campo se usa para agrupar servicios en la API JSON por zonas.
                        </small>
                    </div>
                    ...
                    <div class="community-field full">
                        ...
                        <input
                            ...
                            id="direccion"
                            class="community-input"
                            placeholder="Ejemplo: Calle Goya 10, Madrid"
                            value="{{ old('direccion') }}"
                            required
                        >
                    </div>
                    ...
                    <div class="community-field full">
                        ...
                        <small>
                            Este teléfono se cargará automáticamente al crear un aviso desde el panel de la gestora.
                        </small>
                    </div>
                ...
                <div class="community-summary">
                    <div class="community-summary-card">
                        ...
                        <strong>Crear avisos B2B</strong>
                    </div>

                    <div class="community-summary-card">
                        <span>Dato clave</span>
                        <strong>Teléfono automático</strong>
                    </div>

                    <div class="community-summary-card">
                        <span>API REST</span>
                        <strong>Servicios por zona</strong>
                    </div>
                </div>
